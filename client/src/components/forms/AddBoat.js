...
const AddBoat = () => {
  ...
  return (
    ...
    >
      ...
      <Form.Item
        name='make'
        rules={[{ required: true, message: 'Please input make for the Boat!' }]}
      >
        <Input placeholder='i.e. Coastal Craft' />
      </Form.Item>
      ...
      >
        <Input placeholder='i.e. 33 express' />
      </Form.Item>
      ...
      >
        <Input placeholder='i.e. 500000' />
      </Form.Item>

      <Form.Item
        name='personId'
        rules={[{ required: true, message: 'Please input the person who has this boat!' }]}
      >
